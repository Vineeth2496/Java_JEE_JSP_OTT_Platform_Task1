...
<%
	...
	if (ses != null)
	{
		...
		out.println("<h1>Welcome to NETFLIX<h1></br></br>");
		...
		out.println("<h1> NetFlix user ID:	"+ ses.getId()+ "</h1></br></br>");
		out.println("<h1> NetFlix Runtime milliSeconds: "+ ses.getCreationTime()+ "</h1></br></br>");
