...
<%
	...
	if (ses != null)
	{
		...
		out.println("<h1>Welcome to SonyLIV<h1></br></br>");
		...
		out.println("<h1> SonyLIV user ID:	"+ ses.getId()+ "</h1></br></br>");
		out.println("<h1> SonyLIV Runtime milliSeconds: "+ ses.getCreationTime()+ "</h1></br></br>");
	}
	else
	{
